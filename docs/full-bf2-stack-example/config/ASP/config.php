...
$admin_user = 'admin';
$admin_pass = 'admin';
$admin_hosts = array('0.0.0.0'); // Authorize all IP addresses to login to ASP
...
$debug_lvl = 2;
$game_hosts = array(
    '172.17.0.0/12', // Authorize all docker bridge networks, for the gameserver container to send stats to me over the `bf2-network` docker network
    '192.168.0.0/16', // Authorize all docker bridge networks, for the gameserver container to send stats to me over the `bf2-network` docker network
